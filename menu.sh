...
EOF
    ...
    if systemctl is-active --quiet "$WEBPANEL_SERVICE_NAME"; then
        ...
        echo -e "  ${C_WHITE}URL:${C_RESET}      ${C_CYAN}http://${SERVER_IPV4}:${WEBPANEL_PORT}/${panel_secret}/${C_RESET}"
...
EOF
    ...
    echo -e "${C_TITLE}─────────────────────────────────────────${C_RESET}"
    echo -e "  ${C_WHITE}URL:${C_RESET}      ${C_CYAN}http://${SERVER_IPV4}:${WEBPANEL_PORT}/${new_secret}/${C_RESET}"
