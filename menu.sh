    ...
    while IFS=: read -r user pass expiry limit bandwidth_gb _extra; do
        ...
        if $dynamic_banners_enabled; then
            ...
            if [[ "$bandwidth_gb" != "0" && -n "$bandwidth_gb" ]]; then
             ...
             banner_content="<br><h1 style="text-align:center"><font color="red"><b> 🅰🅼🅾🅺🅷🅰🅽☠️🅲🆈🅱🅴🆁 📛 </b></font><br>"
            banner_content+="<h2><br><small><font color="blue"><b> ✨ 𝗨𝗦𝗘𝗥 𝗗𝗘𝗧𝗔𝗜𝗟𝗦 ✨ </b></font><br><br>"
            banner_content+="<font color="green">👤 <b>𝖴𝖲𝖤𝖱𝖭𝖠𝖬𝖤:</b> $user</font><br>"
            banner_content+="<font color="yellow">📅 <b>𝙴𝚇𝙿𝙸𝚁𝙴 𝙳𝙰𝚃𝙴:</b> $expiry ($days_left)</font><br>"
            banner_content+="<font color="cyan"> 📊 <b>𝔹𝔸ℕ𝔻𝕎𝕀𝔻𝕋ℍ :</b> $bw_info</font><br>"
            banner_content+="<font color="purple">🌎 <b> 𝙾𝙽𝙻𝙸𝙽𝙴 𝚂𝙴𝚂𝚂𝙸𝙾𝙽 :</b> $online_count/$limit</font><br><br>"
            banner_content+="<h1 style="text-align:center"><font color="red">𝗦𝘁𝗮𝘆 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 24𝗛𝗥𝗦"
            banner_content+="<h1 style="text-align:center"><font color="yellow">🤖 <b> 𝑼𝑵𝑨𝑷𝑶𝑷𝑨𝑻𝑨 𝑪𝑯𝑨𝑵𝑮𝑨𝑴𝑶𝑻𝑶 𝑵𝑰𝑪𝑯𝑬𝑲 𝑲𝑾𝑨 𝑯𝑰𝑰 𝑵𝑨𝑴𝑩𝑨 𝑯𝑨𝑷𝑨 𝑪𝑯𝑰𝑵𝑰 </b><br> https://wa.me/255765556877"
...
show_banner() {
    ...
    [[ -t 1 ]] && clear
    echo
    echo -e "${C_TITLE}   𝗔𝗠𝗢𝗞𝗛𝗔𝗡 𝗖𝗬𝗕𝗘𝗥 𝗧𝗘𝗔𝗠🇹🇿    ${C_RESET}${C_DIM}|    ☆V4.0.1 𝚅𝚅𝙸𝙿 ᵉᵈᶦᵗᶦᵒ☆√ ${C_RESET}"
...
protocol_menu() {
    while true; do
        ...
        printf "     ${C_CHOICE}[ 9]${C_RESET} %-45s %s\n" "🦅 Install amokhan proxy (Select Version)" "$falconproxy_status"
