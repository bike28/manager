...
show_banner() {
    ...
    [[ -t 1 ]] && clear
    echo
    echo -e "${C_TITLE}   𝗔𝗠𝗢𝗞𝗛𝗔𝗡 𝗦𝗦𝗛 𝗣𝗥𝗢🇹🇿    ${C_RESET}${C_DIM}|    ☆v7.1 𝚅𝙸𝙿-ᵉᵈᶦᵗᶦᵒⁿ ☆${C_RESET}"
...
protocol_menu() {
    while true; do
        ...
        echo -e "\n   ${C_TITLE}══════════════[ ${C_BOLD}🔌 PANEL MANAGEMENT ${C_RESET}${C_TITLE}]══════════════${C_RESET}"
...
uninstall_script() {
    ...
    echo -e "${C_RED}       🔥 DANGER: UNINSTALL SCRIPT      ${C_RESET}"
    echo -e "${C_RED}=====================================================${C_RESET}"
