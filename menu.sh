...
install_falcon_proxy() {
    ...
    local download_url="https://raw.githubusercontent.com/bike28/manager/releases/download/$SELECTED_VERSION/$binary_name"
...
show_banner() {
    ...
    [[ -t 1 ]] && clear
    echo
    echo -e "${C_TITLE}   AmokhanSSH Manager ${C_RESET}${C_DIM}| v7.0.0 Premium Edition${C_RESET}"
